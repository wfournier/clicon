...
INSERT INTO `account` VALUES (31,'Martel','Remi',NULL,'luxor37@gmail.com','$2y$10$kiUHbYfvsL0xN608dyRLue8HYAHrtdKG9iAZA6U9uaxL24to9q8im',NULL,NULL,'2018-01-01','4506473481','1800 Rue Basset','Longueuil','J4M1W5',38,11,'TRUE',NULL,NULL,'b946de032507e6bcaaa432cab16a4269e400af929b5ac3aacd90442cc6ab685d'),(32,'Fournier','William',NULL,'wfournier2710@gmail.com','$2y$10$Jjkh8MzxEM.YZz8ws1jlPO5FEXKivBSP09peCYp3aA5WBVg5BK24.',NULL,NULL,'1997-10-27','5146229378','7515 Trudeau','Brossard','J4W2N5',38,11,'TRUE',NULL,NULL,'2f329e3d23dc287b1b526ae051adcd487237f749cb847e2307196d202a8123d7');
...
CREATE TABLE `attendee` (
  ...
  UNIQUE KEY `ATTENDEE_ID_UNIQUE` (`ATTENDEE_ID`),
  CONSTRAINT `TICKET_ID_FK` FOREIGN KEY (`TICKET_ID`) REFERENCES `ticket` (`TICKET_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `sessions` (
  ...
  KEY `FK_ACCOUNTID_idx` (`ACCOUNT_ID`),
  CONSTRAINT `SESSIONS_FK_ACCOUNT_ID` FOREIGN KEY (`ACCOUNT_ID`) REFERENCES `account` (`ACCOUNT_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-02-21 16:54:47
