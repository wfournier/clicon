...
INSERT INTO `account` VALUES (1,'User','User',NULL,'user@user.com','$2y$10$wnUOQOojQP9VNIGkNiq6b.MNbciChP9smTuC35e0CYtJa2Yub35zy','2017-01-01','5146229378','7515 Trudeau','Brossard','J4W2N5',38,11,NULL,'TRUE'),(2,'Fournier','William',NULL,'wfournier2710@gmail.com','$2y$10$XF9MQwdJxnnPqOpS7QvdCen86i7y/BrLxtI1qyVqNUyol9gBNG4l6','1997-10-27','5146229378','7515 Trudeau','Brossard','J4W2N5',38,11,NULL,'TRUE');
...
CREATE TABLE `ticket` (
  ...
  CONSTRAINT `TICKET_FK_ACCOUNT_ID` FOREIGN KEY (`ACCOUNT_ID`) REFERENCES `account` (`ACCOUNT_ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-12-14 16:21:52
