CREATE DATABASE  IF NOT EXISTS `gamecon` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `gamecon`;
...
CREATE TABLE `account` (
  ...
  `IS_ADULT` varchar(5) DEFAULT NULL,
  PRIMARY KEY (`ACCOUNT_ID`),
  KEY `ACCOUNT_FK_COUNTRY_ID_idx` (`COUNTRY_ID`),
  KEY `ACCOUNT_FK_STATE_ID_idx` (`STATE_ID`),
  CONSTRAINT `ACCOUNT_FK_COUNTRY_ID` FOREIGN KEY (`COUNTRY_ID`) REFERENCES `countries` (`COUNTRY_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `ACCOUNT_FK_STATE_ID` FOREIGN KEY (`STATE_ID`) REFERENCES `states` (`STATE_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `hotelroom` (
  ...
  CONSTRAINT `HOTEL_ROOM_FK_HOTEL_ID` FOREIGN KEY (`HOTEL_ID`) REFERENCES `hotel` (`HOTEL_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `staff` (
  ...
  CONSTRAINT `STAFF_FK_HOTEL_ROOM_ID` FOREIGN KEY (`HOTEL_ROOM_ID`) REFERENCES `hotelroom` (`HOTEL_ROOM_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `states` (
  ...
  CONSTRAINT `STATES_FK_COUNTRY_ID` FOREIGN KEY (`COUNTRY_ID`) REFERENCES `countries` (`COUNTRY_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE `ticket` (
  ...
  KEY `TICKET_FK_ACCOUNT_ID_idx` (`ACCOUNT_ID`),
...
-- Dump completed on 2017-12-13  9:32:10
