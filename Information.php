...
<head>
    ...
    <link rel="stylesheet" href="/clicon/Style/InformationStyle.css">
    <title>clicon_Information</title>
</head>
<body>
...
<main>
    ...
    <div class="row">
        ...
        <div class="col-lg-4" id="location">
            ...
            <p>800 de la Gauchetière,<br><?php echo($lang("mtl")); ?>, QC H5A 1K6<br>(415)
                397-2233<br><?php echo($lang("open_24h")); ?></p>
        </div>
    </div>
    <!--RULES-->
    <div class="row rules">
        <a><h1 style="text-align: center" data-toggle="collapse" href="#collapse1"
            id="rules"><?php echo($lang("rules")); ?> <span
                        class="plus glyphicon glyphicon-plus"></span></h1></a>
    ...
    <!--REGISTRATION-->
    <div class="row rules">
        <a><h1 style="text-align: center" data-toggle="collapse" href="#collapse2"
            id="registration"><?php echo($lang("registration_policies")); ?>
            <span
                    class="plus glyphicon glyphicon-plus"></span></h1></a>
        <div class="col-md-3"></div>
    ...
    <!--WEAPON-->
    <div class="row rules">
        <a><h1 style="text-align: center" data-toggle="collapse" href="#collapse3"
            id="weapon"><?php echo($lang("weapon")); ?> <span
                        class="plus glyphicon glyphicon-plus"></span></h1></a>
        <div class="col-md-3"></div>
    ...
    <!--AUTOGRAPH-->
    <div class="row rules">
        <a><h1 style="text-align: center" data-toggle="collapse" href="#collapse4"
            id="autograph"><?php echo($lang("autograph")); ?> <span
                        class="plus glyphicon glyphicon-plus"></span></h1></a>
        <div class="col-md-3"></div>
