            ...
            <div class="row">
                <div class="col-md-6" style="padding: 30px">
                    <div class="row">
                        <div class="col-xs-12">
                          <div id="timer-box">
                            <p id="timer-msg" class="guidebook" style="width: 200px">Get the official Otakuthon Mobile Schedule!</p>
                            <img id="guidebook" src="http://otakuthon.com/2017/images/2014/guidebook-devices.png"><br><br>
                            <p id="timer-button" class="en">
                                <a href='https://play.google.com/store/apps/details?id=com.guidebook.android&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1' target="_blank"><img
                                    ...
                                    <a href="https://itunes.apple.com/us/app/guidebook/id428713847?mt=8" target="_blank"><img width="45%"
                                      height="auto"
