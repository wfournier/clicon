			...
			<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="form">
				<div class="row">
					<div class="form-group col-xs-6">
						...
						<input type="text" class="form-control" id="emailRegister" name="emailRegister" value="<?php echo isset($_POST['emailRegister']) ? $_POST['emailRegister'] : '' ?>" data-toggle="tooltip" title="Email must be a valid format (i.e. name@domain.com)">
					</div>
					<div class="form-group col-xs-6">
						<br>
				...
				<div class="row">
					<div class="form-group col-xs-6">
						...
						<input type="text" class="form-control" id="fname" name="fname" value="<?php echo isset($_POST['fname']) ? $_POST['fname'] : '' ?>" data-toggle="tooltip" title="First Name must only contain letters">
					</div>
					<div class="form-group col-xs-6">
						<label for="lname" class="<?php echo $lnameErr ? 'error' : '' ?>">Last Name</label>
						<input type="text" class="form-control" id="lname" name="lname" value="<?php echo isset($_POST['lname']) ? $_POST['lname'] : '' ?>" data-toggle="tooltip" title="Last Name must only contain letters">
					</div>
				</div>
				<div class="row">
					<div class="form-group col-xs-6">
						<label for="passRegister" class="<?php echo $passErr ? 'error' : '' ?>">Password</label>
						<input type="Password" class="form-control" id="passRegister" name="passRegister" data-toggle="tooltip" title="Password must contain be at least 8 characters long, contain numbers and at least 1 uppercase letter">
					</div>
					<div class="form-group col-xs-6">
						<label for="confirmPass" class="<?php echo $confirmPassErr ? 'error' : '' ?>">Confirm Password</label>
						<input type="password" class="form-control" id="confirmPass" name="confirmPass" data-toggle="tooltip" title="Both passwords must match">
					</div>
				</div>
				<div class="row">
				...
				<div class="row">
					<div class="form-group col-xs-6">
						...
						<input type="tel" class="form-control" id="phone" name="phone" value="<?php echo isset($_POST['phone']) ? $_POST['phone'] : '' ?>" data-toggle="tooltip" title="Phone number must be valid (i.e. 000-000-0000)">
					</div>
				</div>
				<div class="row">
					<div class="form-group col-xs-6">
					...
					<div class="form-group col-xs-6">
						...
						<input type="text" class="form-control" id="stateCode" name="stateCode" maxlength="2" value="<?php echo isset($_POST['stateCode']) ? strtoupper($_POST['stateCode']) : '' ?>" data-toggle="tooltip" title="State code must be 2 characters long (i.e. FL)">
					</div>
				</div>
				<div class="row">
					<div class="form-group col-xs-6">
						<label for="city" class="<?php echo $cityErr ? 'error' : '' ?>">City</label>
						<input type="text" class="form-control" id="city" name="city" value="<?php echo isset($_POST['city']) ? $_POST['city'] : '' ?>" data-toggle="tooltip" title="City must only contain letters (i.e. Anytown)">
					</div>
				</div>
				<div class="row">
					<div class="form-group col-xs-6">
						<label for="address" class="<?php echo $addressErr ? 'error' : '' ?>">Address</label>
						<input type="text" class="form-control" id="address" name="address" value="<?php echo isset($_POST['address']) ? $_POST['address'] : '' ?>" data-toggle="tooltip" title="Address must be valid (i.e. 123 Main Street)">
					</div>
					<div class="form-group col-xs-6">
...
=======
    <div class="content row">
        ...
        <div id="register" class="col-sm-3"  style="border-left: solid white 1px">
            <h2 class="page-header">REGISTER</h2><br>
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="form">
                <div class="row">
                    <div class="form-group col-xs-6">
                ...
                <div class="row">
                    <div class="form-group col-xs-6">
                        ...
                        <input type="text" class="form-control" id="city" name="city"
                               ...
                               data-toggle="tooltip" title="City must only contain letters (i.e. Anytown)">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-xs-6">
...
>>>>>>> 95f687f56a6378112718a5621c454cc3940cd1d3
</main>
