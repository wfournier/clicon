        ...
        <div class="content row">
            ...
            <div class="col-sm-6">
                <table class="table table-hover" border="2">
                    ...
                    <?php
                    $get_transactions = "SELECT * FROM transaction WHERE ACCOUNT_ID = " .$con->real_escape_string($_COOKIE['account_id']);
                    ...
                    if($get_transactions_res->num_rows < 1){
                        ...
                        while($transaction = $get_transactions_res->fetch_array()){
                            ...
                            $get_ticket_count_res = $con->query("SELECT count(*) AS TICKET_COUNT FROM ticket WHERE TRANSACTION_ID = " .$con->real_escape_string($transaction["TRANSACTION_ID"])) or die("ticket_count: " .$con->error);
